...
/// Structure for reporting chunk details for logging/auditing
...
/// Implements chunk logging for auditing
#[allow(dead_code)]
...
pub async fn write_manifest(
    ...
    // Windows-compatible timestamp format (without ":" which is invalid in file names)
...
pub async fn read_manifest(
    ...
    // Try to decompress if the content is compressed
    let mut decompressed = Vec::new();
    if copy_decode(&raw[..], &mut decompressed).is_ok() {
        info!("📚 Manifest successfully decompressed");
