...
impl NotificationHistory {
    /// Creates a new history with entry limit
    ...
    /// Adds a successful synchronization notification
    ...
    /// Adds a webhook sent notification
...
impl HistorySummary {
    ...
    /// Most common type (based on count)
...
mod tests {
    ...
    fn test_add_error() {
        let mut history = NotificationHistory::new(10);
        history.add_error("Synchronization error", "Permission denied");
        assert_eq!(history.len(), 1);
